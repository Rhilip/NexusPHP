...
$res = \NexusPHP\Components\Database::query("SELECT username, class, email FROM users WHERE id=".\NexusPHP\Components\Database::real_escape_string($id));
$arr = mysqli_fetch_assoc($res) or stderr("Error", "No such user.");
