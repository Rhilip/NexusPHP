                ...
                if (array_key_exists("items", $faq_categ[$id])) {
                    foreach ($faq_categ[$id][items] as $id2 => $temp) {
                        if ($faq_categ[$id][items][$id2][flag] == "1") {
                            print("<li><a href=\"#id". $faq_categ[$id][items][$id2][link_id] ."\" class=\"faqlink\">". $faq_categ[$id][items][$id2][question] ."</a></li>\n");
                        } elseif ($faq_categ[$id][items][$id2][flag] == "2") {
                            print("<li><a href=\"#id". $faq_categ[$id][items][$id2][link_id] ."\" class=\"faqlink\">". $faq_categ[$id][items][$id2][question] ."</a> <img class=\"faq_updated\" src=\"pic/trans.gif\" alt=\"Updated\" /></li>\n");
                        } elseif ($faq_categ[$id][items][$id2][flag] == "3") {
                            print("<li><a href=\"#id". $faq_categ[$id][items][$id2][link_id] ."\" class=\"faqlink\">". $faq_categ[$id][items][$id2][question] ."</a> <img class=\"faq_new\" src=\"pic/trans.gif\" alt=\"New\" /></li>\n");
                        }
                    }
                }
                print("</ul></li></ul><br />");
