            ...
            if (array_key_exists("items", $temp2[$id])) {
                foreach ($temp2[$id][items] as $id2 => $temp) {
                    ...
                    if ($temp2[$id][items][$id2][flag] == "0") {
                        ...
                        $status = "<font color=\"#0000FF\"><img src=\"pic/updated.png\" alt=\"Updated\" width=\"46\" height=\"11\" align=\"absbottom\"></font>";
                    } elseif ($temp2[$id][items][$id2][flag] == "3") {
                        $status = "<font color=\"#008000\"><img src=\"pic/new.png\" alt=\"New\" width=\"27\" height=\"11\" align=\"absbottom\"></font>";
                    } else {
                        $status = "Normal";
                    }
