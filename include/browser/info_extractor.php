...
{
    public function info_extractor()
    {
    }
   ...
   */
    public function truncate($src, $s_str, $e_str = "", $e_offset = 0)
    {
        $ret = "";
   ...
   */
    public function find_pattern($src, $regex, $multiple, $res_where_array)
    {
        $res_array = array();
        if ($multiple == true) {
   ...
   */
    public function remove($src, $regex_s, $regex_e, $max = 100, $all = false)
    {
        $ret = "";
   ...
   * @return string processed string
   */
    public function trim_str($src, $regex_trim_array, $safe_counter =10)
    {
        $ret = "";
